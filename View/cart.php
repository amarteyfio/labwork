...
<body>
    ...
    <ul style="padding: 1px;">
        ...
        ?>
        <li><?php echo $prod['product_title'];?> | QTY : <input type="text" id = "<?php echo $prod['product_id'];?>" size = "3" maxlength="5" value ="<?php echo $item['qty'];?>"><a onclick="quantadd(<?php echo $prod['product_id'];?>)"><button type = "submit" id="sub">Manage QTY</button></a> | <a href="../Actions/remove_from_cart.php?pid=<?php echo $item['p_id'];?>" onclick="return confirm('Remove from Cart?')"><Button>Remove From Cart</Button></a></li>
        <br>
        <?php endforeach; ?>
    </ul>
