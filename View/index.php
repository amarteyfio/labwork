...
<body>
    ...
    <div>
        ...
        if($_SESSION['role'] == 1)
        {
            echo "<a href='$logout'>LOGOUT</a> | <a href='$register'>REGISTER</a> | <a href = '$brand'>BRAND</a> | <a href = '$category'>CATEGORY</a> | <a href='$product'>ADD PRODUCT</a> | <a href='$allprod'>ALL PRODUCTS</a> | <br><br><form action = '../Actions/product_functions.php' method 'POST'> <input type = 'text' name = 'term' id = 'search_term' placeholder = 'Search for a product'><input type = 'submit' name = 'search' id = 'search'></form>";
        }
        else
        {
           echo "<a href='$logout'>LOGOUT</a> | <a href='$register'>REGISTER</a> | <a href='$product'>ADD PRODUCT</a> | <a href='$allprod'>ALL PRODUCTS</a> | <br><br><form action = '../Actions/product_functions.php' method 'POST'> <input type = 'text' name = 'term' id = 'search_term' placeholder = 'Search for a product'><input type ='submit' name ='search' id ='search'></form>";
        }
