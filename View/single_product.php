                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><a href="single_product.php?id=<?php echo $relprod['product_id'];?>" style="text-decoration:none; color:black;"><?php echo $product['product_title']; ?></a></h5>
                                    <!-- Product price-->
